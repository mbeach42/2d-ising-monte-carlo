...
function magnetization(M::Array{Int64,2})::Int64
    return abs(sum(M))
end

function energy_singleflip(M::Array{Int64,2}, i::Int64, j::Int64, L::Int64)::Int64 #energy of configuration
...
function energy(M::Array{Int64,2}, L::Int64)::Int64 #energy of configuration
    E = 0
...
function mcstep!(config::Array{Int64,2}, L::Int64, T::Float64, pre_exp::Array{Float64, 1}, flipx::Int64, flipy::Int64, rand_num::Float64) #Monte Carlo step
...
function mcsweep!(config::Array{Int64,2}, T::Float64, L::Int64, pre_exp::Array{Float64, 1},
